...
function canWeDeliver(zipCode) {
    ...
    return console.log("You are not in our delivery zone.")
}
...
const canWeDeliverTwo = (zipCode) => {
    if(deliveryAreaZipCodes.includes(zipCode)) {
        ...
        return console.log(`We cant deliver to that address`)
    }
}

canWeDeliverTwo(94954)
